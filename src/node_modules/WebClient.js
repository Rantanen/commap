...
var MapSelector = require('MapSelector');
...
WebClient.prototype.connected = function (server, mapData, config) {
    ...
    this.mapSelector = new MapSelector( $('#continent'), game );
    this.model = new MapModel( mapData, game );
    this.map = new CommandMap( this.model, game );
    this.map.changeContinent( this.mapSelector.currentContinent );
    ...
    this.mapSelector.on( 'continentChanged', function( continent ) {
        self.map.changeContinent( continent );
    });
